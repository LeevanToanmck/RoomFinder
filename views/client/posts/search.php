...
<div class="posts-page">
    <div class="posts-header">
        ...
        <?php if (!empty($search)): ?>
            <p class="search-sub">Từ khóa: "<?php echo htmlspecialchars($search); ?>"</p>
        <?php endif; ?>
    </div>

    <?php if (empty($search)): ?>
        <div class="no-results">Nhập từ khóa để tìm bài đăng.</div>
    <?php elseif (empty($posts)): ?>
        <div class="no-results">Không tìm thấy bài đăng phù hợp.</div>
    <?php else: ?>
